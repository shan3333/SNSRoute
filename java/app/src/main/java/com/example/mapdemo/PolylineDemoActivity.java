...
public class PolylineDemoActivity extends AppCompatActivity
    ...
    //2019.11.2 Add Sheffield
    private static final LatLng SHEFFIELD = new LatLng(53.3867785,-1.4803219);
    private static final LatLng AMERICA = new LatLng(37.4219983, -122.084);

    //2019.11.2 Our data
    private static final LatLng MAPP = new LatLng(53.381223, -1.478787);
    private static final LatLng DIMO = new LatLng(53.3812536,-1.4788018);
    private static final LatLng KFC = new LatLng(53.3806786,-1.479487);
    private static final LatLng IC = new LatLng(53.3846049,-1.4751211);
    private static final LatLng IQ = new LatLng(53.37778,-1.4774266);

    //    double pointX[]={53.381223,53.3812536,53.3806786,53.3846049,53.37778};
//    double pointY[]={-1.478787,-1.4788018,-1.479487,-1.4751211,-1.4774266};
...
//    private static final LatLng LHR = new LatLng(51.471547, -0.460052);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWidthBar.setProgress(MAX_WIDTH_PX / 6);
...
//                        byte[] al = (byte[]) ois.readObject();
                String al = (String) ois.readObject();
                String los[] = al.split("\\r?\\n");
...
//                }
//                br.close();
//                String al = text.toString();
//                Log.i("text: ", al);
//                String los[] = al.split("\\r?\\n");

                for (String lo : los) {
                    String point[] = lo.split(",");
                    pointX.add(Double.parseDouble(point[0]));
                    pointY.add(Double.parseDouble(point[1]));
//                    Log.i("point: ", point[0] + point[1]);
        ...
        for (int i = 0; i < pointX.size(); i++){
            points.add(new LatLng(pointX.get(i),pointY.get(i)));
        };
//        points.add(new LatLng(37.4444444, -121.1111111));
        LatLng[] pointsArr = new LatLng[points.size()];
...
//                .add(MELBOURNE, ADELAIDE, PERTH, DARWIN));
        ...
        map.moveCamera(CameraUpdateFactory.newLatLngZoom(AMERICA, 3));
