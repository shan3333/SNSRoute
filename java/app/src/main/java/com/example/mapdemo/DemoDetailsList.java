...
public final class DemoDetailsList {
    ...
    public static final DemoDetails[] DEMOS = {
            ...
            new DemoDetails(R.string.input_customer_label,R.string.input_customer_description,InputDemoActivity.class),
            new DemoDetails(R.string.compare_label,R.string.compare_description,CompareDemo.class),
